...
Este repositório reúne os artefatos visuais, diagramas e protótipos de alta resolução desenvolvidos no âmbito do Trabalho de Conclusão de Curso (TCC) em Bacharelado em Sistemas de Informação pelo **Instituto Federal do Ceará (IFCE) - Campus Cedro**.

O projeto **Descubra +Cidades** é uma solução de engenharia de usabilidade e IHC (Interação Humano-Computador) desenhada para combater a invisibilidade digital do turismo regional e facilitar o planeamento de viagens em cidades de pequeno porte, tendo como foco prático a região Centro-Sul do Ceará e o município de Várzea Alegre.

---

## 🚀 Links Rápidos

* 🎨 [Protótipo Interativo no Figma](https://www.figma.com/design/7TstedD0eCQhscs3QO4oVC/PROTOTIPO?m=auto&t=CttBbOIHkuz0Dhd3-6)
* 📊 [Relatório de Testes de Usabilidade (Maze)](https://docs.google.com/document/d/1bfNpOv0dacUVOwttSunUVkERJfOJWHIPsLfACoehuKk/edit?usp=sharing)

---

## 📐 Estrutura Metodológica (Double Diamond)
...
Este projeto foi desenhado de forma colaborativa durante o *Scholarship Program* da Compass UOL (Trilha de Product Design) por:
*   **Maria Eduarda Clementino Aires** (Análise científica, documentação de IHC e escrita do TCC)
*   **Camilly Beatriz** (Cocriação e design de interface)
*   **Jadienne Costa** (Cocriação e design de interface)

**Orientador:** [José Olinda da Silva]  
**Instituição:** Instituto Federal de Educação, Ciência e Tecnologia do Ceará (IFCE) — Campus Cedro.
